...
$DB = DB::setInstall('sqlite:C:/one/sqlite/testDB.db','','');
//$DB->encode();
//$DB->encode();
...
//$ookx = $DB->getAll('SELECT * FROM COMPANY WHERE  ID = ?', [3]);

$ins = $DB->insert('COMPANY', ['ID' => 5, 'NAME' => 'chaoge', 'AGE' => 222, 'ADDRESS' => 'post', 'SALARY' => 999]);
